<template>
    <div class="flex flex-col gap-4 relative">
        ...
        <div class="flex justify-between items-center mt-2 mx-3 z-10">
            ...
            <div class="flex-shrink-0 flex items-center gap-x-2 justify-end">
                <RouterLink to="/notifikasi" class="flex justify-center items-center bg-white hover:bg-lime-50 rounded-xl p-2 shadow shadow-gray-500/5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <!-- Home Menu -->
        <div class="grid grid-cols-3 bg-white rounded-2xl mx-3 z-10 shadow shadow-gray-500/10">
            <template v-for="menu in menus" :key="menu?.path">
                <RouterLink
                    :to="menu?.path"
                    class="flex flex-col items-center gap-y-1 text-center p-3"
                >
        ...
        <div class="flex flex-col gap-y-2 mx-3">
            <div class="flex justify-between items-center">
                <h2 class="flex-grow text-sm font-semibold text-gray-600">Riwayat Pembayaran</h2>
                <RouterLink class="text-xs text-gray-500 flex items-center gap-x-1" to="/pembayaran">
            ...
            <div class="flex flex-col gap-1">
                <template v-for="item in [1,2,3,4,5,6,7,8]" :key="item">
                    <div class="flex gap-x-2 rounded-2xl bg-white p-3">
                        <div class="flex-shrink-0 rounded-xl bg-white shadow shadow-gray-500/10 p-2 bg-gradient-to-br from-lime-700 to-lime-400 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                            </svg>
                        </div>
                        <div class="flex-grow flex flex-col gap-y-1 text-sm">
                            <h4>Pembayaran IPL bulan <strong>{{ item }}</strong></h4>
                            <small>0{{ item }}/0{{ item }}/2025</small>
                        </div>
                    </div>
                </template>
            </div>
...
const menus = [
    ...
    },
    {
        ...
        icon: `
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 text-lime-600">
